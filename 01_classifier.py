...
model.add(Conv2D(32, (3, 3), activation=act1, kernel_initializer=ki))
...
model.add(MaxPooling2D(pool_size=(2, 2)))
model.add(Flatten())
model.add(Dense(64, activation=act1, kernel_initializer=ki))
...
model.save("models/classifier_conv2d.h5")
